...
{
    setWindowTitle(tr("QtitanDataGrid Demo (Banded table view)"));
    ...
    Qtitan::GridTableBand* lineBand = view->addBand("Line");
    Qtitan::GridTableBand* aircraftBand = view->addBand("Details");
