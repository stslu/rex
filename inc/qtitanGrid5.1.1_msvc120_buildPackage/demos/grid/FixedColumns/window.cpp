...
{
    setWindowTitle(tr("QtitanDataGrid - Fixed Columns"));
    ...
    column->setFixedKind(Qtitan::FixedLeft);

    column = (Qtitan::GridTableColumn *)view->getColumnByModelColumnName("History");
    column->setEditorType(Qtitan::ComboBoxBlobEditorType);
    column->setFixedKind(Qtitan::FixedRight);
